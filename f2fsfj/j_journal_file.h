...
#define F2FSJ_SB_BLOCK1_ADDR (6232476)
...
#define J_LOG_ENTRY_PER_FILE (64 * 1024 * 1024 / J_LOG_ENTRY_SIZE)
...
typedef struct __j_jsb_info
{
    ...
    uint32_t j_current_small_file;  // 0-3
...
typedef struct __j_file_mapping_t
{
    ...
    uint32_t j_cur_file_free_blk; ///< the first used block, write journal from this block
