...
static int f2fs_compress_pages(struct compress_ctx *cc)
{
	...
	trace_f2fsj_compress_pages_start(cc->inode, cc->cluster_idx,
	...
	trace_f2fsj_compress_pages_end(cc->inode, cc->cluster_idx,
							cc->clen, ret);
	return 0;
...
void f2fs_decompress_cluster(struct decompress_io_ctx *dic)
{
	...
	trace_f2fsj_decompress_pages_start(dic->inode, dic->cluster_idx,
...
out_end_io:
	trace_f2fsj_decompress_pages_end(dic->inode, dic->cluster_idx,
							dic->clen, ret);
